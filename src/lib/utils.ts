...
/**
 * Slugify a string (e.g., "My Workspace" → "my-workspace")
 */
 ...
 */
export function apiError(error: string, message: string, status: number = 400) {
...
/**
 * Generate a workspace identifier from name (e.g., "My Project" → "MP")
 */
